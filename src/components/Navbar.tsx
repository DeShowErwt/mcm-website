    ...
    return (
        ...
        <div className="flex items-center">
            <a href="/" className="duration-150">
                <img src="/logo-mcm.png" className={"w-auto duration-150 " + (props.shrink ? "h-8" : "h-16")} alt="logo" />
            </a>
            <div className="group flex">
                <h1 className="text-2xl font-bold ml-4">Mi Casa Moments</h1>
                {/* Could change these effects, for illustration */}
                <img src="/sun.png" hidden={props.shrink} className="relative right-4 group-hover:-translate-x-2 size-4 duration-150 group-hover:rotate-45 ml-4 translate-y-1 group-hover:-translate-y-2 opacity-0 group-hover:opacity-100" alt="logo" />
            </div>
        </div>
